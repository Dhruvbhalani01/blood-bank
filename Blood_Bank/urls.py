...
# from blood_app.views import home
# from blood_app.views import about
...
#     path('dominator_blood', donator_blood, name='dominator_blood'),
...
from django.conf import settings
from django.conf.urls.static import static
from blood_app.views import Home,About
urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Home, name='home'),
    path('admin_home', admin_home, name='admin_home'),
